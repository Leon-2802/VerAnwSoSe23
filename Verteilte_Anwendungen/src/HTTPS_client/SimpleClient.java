...
//			get("https://www.bundestag.de/presse");
	...
	public static void get(String urlString) throws UnknownHostException, IOException {
	...
	public static boolean urlExists(String s) throws UnknownHostException, IOException {
		URL url = new URL(s);
		int port = url.getPort() == -1 ? url.getDefaultPort() : url.getPort();
